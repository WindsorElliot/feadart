...
as double,chassisPitch: freezed == chassisPitch ? _self.chassisPitch : chassisPitch // ignore: cast_nullable_to_non_nullable
as double?,wheelCamber: freezed == wheelCamber ? _self.wheelCamber : wheelCamber // ignore: cast_nullable_to_non_nullable
as List<double>?,wheelCamberGain: freezed == wheelCamberGain ? _self.wheelCamberGain : wheelCamberGain // ignore: cast_nullable_to_non_nullable
as List<double>?,
  ));
}
/// Create a copy of PacketMotionExData
...
@override final  double? chassisPitch;
 final  List<double>? _wheelCamber;
@override List<double>? get wheelCamber {
  final value = _wheelCamber;
  if (value == null) return null;
  if (_wheelCamber is EqualUnmodifiableListView) return _wheelCamber;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(value);
}

 final  List<double>? _wheelCamberGain;
@override List<double>? get wheelCamberGain {
  final value = _wheelCamberGain;
  if (value == null) return null;
  if (_wheelCamberGain is EqualUnmodifiableListView) return _wheelCamberGain;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(value);
}
...
as double,chassisYaw: null == chassisYaw ? _self.chassisYaw : chassisYaw // ignore: cast_nullable_to_non_nullable
as double,chassisPitch: freezed == chassisPitch ? _self.chassisPitch : chassisPitch // ignore: cast_nullable_to_non_nullable
as double?,wheelCamber: freezed == wheelCamber ? _self._wheelCamber : wheelCamber // ignore: cast_nullable_to_non_nullable
as List<double>?,wheelCamberGain: freezed == wheelCamberGain ? _self._wheelCamberGain : wheelCamberGain // ignore: cast_nullable_to_non_nullable
as List<double>?,
  ));
}
